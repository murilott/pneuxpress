...
public class ModeloController {
    ...
    public ModelAndView index(){
        var mv = new ModelAndView("modelo/index");
    ...
    public ModelAndView novo(){
        var mv = new ModelAndView("modelo/novo");
        mv.addObject("elemento", new Modelo());
        return mv;
    }

    @PostMapping
    @RequestMapping("/salvar")
    public ModelAndView salvarNovo(@ModelAttribute("elemento") Modelo modelo){
        try{
            service.salvar(modelo);
            return new ModelAndView("redirect:/modelo");
        }catch (Exception e){
            var mv = new ModelAndView("modelo/novo");
            mv.addObject("elemento", modelo);
    ...
    public ModelAndView editar(@PathVariable long id){
        var mv = new ModelAndView("modelo/editar");
